...
public class StationControllerIT {
    ...
    public void setUp(){
        ...
        StationDTO stationDTO2 = new StationDTO(2, "address2", "name2", null, 45, 19, true);
        //testCreateStation(stationDTO2, "{id:2, address:address2, name:name2, lines:[], lat:45, lng:19, active:true}");
